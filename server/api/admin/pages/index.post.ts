...
export default defineEventHandler(async (event) => {
  try {
    ...
    const pageData: Partial<DbPage> = {
      ...
      type: body.type || 'page',
      show_to_header_menu: body.show_to_header_menu !== undefined ? (body.show_to_header_menu ? 1 : 0) : 0,
      show_to_footer_menu: body.show_to_footer_menu !== undefined ? (body.show_to_footer_menu ? 1 : 0) : 0,
